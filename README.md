...
To solve this problem, the bank wants to introduce an intelligent loan approval system powered by Machine Learning that can automatically analyse applicant details and  
...
In terms of overall performance, Logistic Regression outperforms the other models mentioned above. Logistic Regression produced the highest accuracy (0.88) and recall (0.83), offering the best balance for reducing both Type 1 and Type 2 errors in loan approvals, while Naive Bayes produced a slightly higher precision (0.81).
